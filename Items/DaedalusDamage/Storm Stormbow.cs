...
{
    class StormStormbow : DaedalusDamageItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Quite a Dreary Day");
        }
        public override void SafeSetDefaults()
        {
            ...
            item.knockBack = 2f;
            item.maxStack = 1;
            item.shoot = ProjectileID.RainCloudRaining;
            item.shootSpeed = 20f;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.NimbusRod, 2);
