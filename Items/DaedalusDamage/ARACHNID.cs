...
{
    class DaedalusArachnid : DaedalusDamageItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Better then a dead spider!");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.SpiderFang, 25);
            recipe.AddIngredient(ItemID.PoisonDart, 400);
